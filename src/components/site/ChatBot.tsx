...
export function ChatBot() {
  ...
  return (
    <>
      ...
      {!open && (
        <div
          className="fixed bottom-24 right-5 sm:bottom-28 sm:right-7 z-[9998] pointer-events-none animate-[monica-rise_.8s_ease-out_both]"
      ...
      <button
        ...
        className="btn-gold rounded-full shadow-glow flex items-center gap-2.5 pl-5 pr-6 py-4 text-sm font-semibold tracking-wide"
      >
        {!open && (
          <span
            aria-hidden
      ...
      {/* Panel */}
      <div
        className={`fixed z-[9998] left-3 right-3 sm:left-auto sm:right-7 bottom-24 sm:bottom-28 w-auto sm:w-[400px] max-w-[440px] origin-bottom-right transition-all duration-300 ${
