...
export function Catering() {
  return (
    <section id="catering" className="py-24 sm:py-32 px-6 sm:px-12 lg:px-20 max-w-7xl mx-auto">
      <div className="rounded-[2rem] p-10 sm:p-16 shadow-soft" style={{ backgroundColor: "oklch(0.93 0.03 75)" }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <span className="text-xs uppercase tracking-[0.3em] font-medium" style={{ color: "oklch(0.71 0.13 75)" }}>Catering</span>
            <h2 className="mt-3 text-4xl sm:text-5xl font-light text-balance" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
